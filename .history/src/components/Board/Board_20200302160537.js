...
const Board = (props) => {
    ...
    useEffect(()=>{
        ...
        tl
        .staggerFrom(titleBackground,.3,{x:"-150%", ease:"sin.out"},0.3)
        .staggerFrom(chars,.3,{x:100,ease:"sin.out( 1.7)"},0.04)
    ...
    return (
        ...
        <div className="board-animation">
            <div className="title-container">
                ...
                <div className="title">
                   <h3 className="text-letter">Kevin <div className="dot"></div> </h3>
                </div>
            ...
            <Image image={"./assets/img/mountain.webp"} />
