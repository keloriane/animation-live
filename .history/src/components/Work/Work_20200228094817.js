...
export const Work = () => {
    ...
    useEffect(()=> {
        ...
        gsap.from(imageSlider,.8,{x:"-100%", delay: .5, ease:"ease.out"})
    })
    return (
                ...
                <div className="inner--left--container">
                    ...
                    <div className="work--navigation">
                        <div className="previous">
                            <button className="button-nav button--previous" onClick={handleSlider}> Next </button>
                        </div>
                        <div className="next">
                            <button className="button-nav button--next">Prev</button>
                        </div>
                    </div>
